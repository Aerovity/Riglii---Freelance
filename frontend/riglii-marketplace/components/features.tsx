...
export function Features({ collapseDelay = 5000, ltr = false, linePosition = "left", data = [] }: FeaturesProps) {
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto my-12 grid h-full items-center gap-10 lg:grid-cols-2">
            ...
            >
              ...
              >
                {data.map((item, index) => (
                  <AccordionItem key={item.id} className="relative mb-8 last:mb-0" value={`item-${index}`}>
                    ...
                    {linePosition === "top" || linePosition === "bottom" ? (
                      ...
                      >
                        <div
                          className={`absolute left-0 ${linePosition === "bottom" ? "bottom-0" : "top-0"} h-full ${
                    ...
                    <div className="relative flex items-center">
                      ...
                      <div>
                        <AccordionTrigger className="pl-0 text-xl font-bold">{item.title}</AccordionTrigger>
